          ...
          <form onSubmit={handleSignup}>
            <div style={{ marginBottom: "14px" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input id="signup-name" type="text" className="input-field" placeholder="Your name" value={name} onChange={(e) => setName(e.target.value)} style={{ paddingLeft: "40px" }} required />
              </div>
            </div>
            <div style={{ marginBottom: "14px" }}>
